...
bool SetScene::init()
{
	...
	auto audio = AudioEngine::play2d("bkMusic.mp3", true);
	AudioEngine::setVolume(audio, 0.0f);
	/*创建菜单*/
	...
	/*设置坐标*/
	bkMusicLab->setPosition(600 - MOVE_X, 440);
	Menu01->setPosition(Point(950 - MOVE_X, 440));
	Menu02->setPosition(Point(950 - MOVE_X, 440 ));
	Menu03->setPosition(1200 - MOVE_X_X, 660 + MOVE_Y);
	...
	volumeLab->setPosition(500 - MOVE_X, 260 );
	volumeNumLab->setPosition(710 - MOVE_X, 260 );
	MenuHigherVolume->setPosition(850 - MOVE_X, 250);
	MenuLowerVolume->setPosition(960 - MOVE_X, 260);
	...
	MenuItemImage* pCloseItem = MenuItemImage::create(
		"CloseNormal.png",
		"CloseSelected.png",
		CC_CALLBACK_1(SetScene::popScene, this));
...
void SetScene::menuCloseCallbackVolumeHigher(Ref* pSender) {
	...
	/*修改音量*/
	volume += 10;
	AudioEngine::setVolume(audio, volume / 100.0f);
...
void SetScene::popScene(Ref* pSender)
{
	Director::getInstance()->popScene();
}
